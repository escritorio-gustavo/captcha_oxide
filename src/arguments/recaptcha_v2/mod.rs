...
/// # use std::env;
/// use captcha_oxide::{
///     arguments::{CaptchaArguments, RecaptchaV2},
...
impl CaptchaArguments<'_, RecaptchaV2Builder<PageUrlNotProvided, SiteKeyNotProvided>>
    for RecaptchaV2
{
    fn builder() -> RecaptchaV2Builder<PageUrlNotProvided, SiteKeyNotProvided> {
